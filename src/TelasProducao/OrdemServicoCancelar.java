 ...
 */
public class OrdemServicoCancelar extends javax.swing.JFrame {
    //int's
    ...
    public OrdemServicoCancelar(int IdOrdemServico){
    ...
    private void initComponents() {
        ...
        setTitle("Cancelar Ordem de Serviço");
        ...
        jLabel1.setText("Cancelar Orderm de Serviço");
        ...
        jLabel5.setText("Detalhes do Cancelamento:");
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {bt_pesquisarCancelamento, jLabel2, jLabel3, jLabel5, label_descricaoCancelamento, txt_codigoCancelamento, txt_codigoOrdemServico});
    ...
    private void bt_confirmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_confirmaActionPerformed
        ...
        sql = "update tb_os set statusOs = 1, "
                             ...
                             + "dataCancelou = '"           + bos.dataCancelou         + "', "
                             + "horaCancelou = '"           + bos.horaCancelou         + "', "
    ...
    public String getRetornoCancelaOrdemServico(){
        return sqlstate;
    }
    
    private void PegaOrdemServico(){
        sql = "select idOrdemServico, idEmpresa, codigoGrupo, codigoEmpresa, codigoOrdemServico, codigoCliente, codigoUsuario, statusOs from tb_os where idOrdemServico = " + bos.idOrdemServico + ";";
    ...
    private void PegaValores(){
        ...
        bos.codigoCancelamento         = Integer.parseInt(txt_codigoCancelamento.getText());
        bos.detalhesCancelamento       = txt_detalhesCancelamento.getText();
        if(bos.detalhesCancelamento.equals("")){
            fatal = "S";
            Mensagem = "Motivo do Cancelamento Inválido!";
            new MostraMensagem(Mensagem);
            return;
        }
        bos.dataCancelou               = invdata.inverterData(cdh.CapturarData(), 2);
        bos.horaCancelou               = cdh.CapturaHora();
        bos.usuarioCancelou            = parametrosNS.bu.codigoUsuario;
        bos.idEmpresaCancelou          = parametrosNS.be.IdEmpresa;
        bos.computadorCancelou         = parametrosNS.bcomp.codigoComputador;
    }
