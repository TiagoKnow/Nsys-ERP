...
public class MenuFiscal extends javax.swing.JFrame {
    ...
    public MenuFiscal(JFrame frame){
        initComponents();
        Frame       = frame;
    ...
    private void CarregarAbas() {
        bm.abasFiscal       = parametrosNS.bm.abasFiscal;
        bm.abaConsultas     = bm.abasFiscal.substring(0, 1);
        bm.abaArquivo       = bm.abasFiscal.substring(1, 2);
        bm.abaMovimentos    = bm.abasFiscal.substring(2, 3);
        bm.abaRelatorios    = bm.abasFiscal.substring(3, 4);
        bm.abaParametros    = bm.abasFiscal.substring(4, 5);
        bm.abaEspeciais     = bm.abasFiscal.substring(5, 6);
        VerificaAbas();
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        setTitle("Módulo Fiscal: " + fc.FormataCampo(String.valueOf(parametrosNS.bge.codigoGrupo), 2, 0) + "." + parametrosNS.bge.nomeGrupo + " - " + fc.FormataCampo(String.valueOf(parametrosNS.be.CodigoEmpresa), 3, 0) + "." + parametrosNS.be.NomeEmpresa);
