 ...
 */
public class GerarBoletoSantander extends javax.swing.JFrame {
    //String's
    String  sql                     = "";
    String  sql1                    = "";
    String  fatal                   = "";
    ...
    public GerarBoletoSantander(ArrayList DadosPadroes){
    ...
    private void PegaDadosBancoSantander(){
        ...
        PegaAgenciaEContaCorrentePadraoSantander();
    }
    
    private void PegaAgenciaEContaCorrentePadraoSantander(){
        ...
        PegaDadosAgenciaEContaCorrentePadraoSantander();
        if(!bb.codigoBanco.equals("033")){
            txt_codigoBoleto.grabFocus();
            Mensagem = "Boleto Selecionado não pertence ao Santander!";
            new MostraMensagem(Mensagem);
            return;
        }
        HabilitaBotoes();
    ...
    private void initComponents() {
        ...
        setTitle("Gerar Boleto Santander");
        setResizable(false);
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/18x18/Santander.jpg"))); // NOI18N
        ...
        txt_numeroDaCarteira.setText("CSR");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txt_dataDeVencimento, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(txt_dataDeEmissao, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );

        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel10, jLabel11, jLabel12, jLabel14, jLabel15, jLabel9});

        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel13, jLabel5});
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {check_VencimentoDiasUteis, jLabel10, jLabel11, jLabel12, jLabel14, jLabel15, jLabel9, txt_dataDeEmissao, txt_valorDevido});

        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel5, txt_numeroDaCarteira});

        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {combo_vencimentoDasParcelas, jLabel13});

        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel6, txt_numeroDocumento});
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txt_segundaInstrucao, javax.swing.GroupLayout.DEFAULT_SIZE, 345, Short.MAX_VALUE)
                    .addComponent(txt_terceiraInstrucao, javax.swing.GroupLayout.DEFAULT_SIZE, 345, Short.MAX_VALUE)
                    .addComponent(combo_Instrucoes, 0, 345, Short.MAX_VALUE))
    ...
    private void NovoBoleto(){
        ...
        bbol.codigoBoleto   = PegProReg.PegaProximoRegistro("tb_boletos", "codigoBoleto", " and substring(CodigoDeBarras, 1, 3) = 033");
    ...
    private void bt_emailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_emailActionPerformed
        ...
        parametros.add("Boleto Santander");
        parametros.add("Boleto Santander no valor de " + TransStrDou.TransformaValorStringeDouble(String.valueOf(bbol.valorDevido), 0));
    ...
    private void PegaDadosBoleto(){
        for(int i = 0; i < dadosBoletos.size(); i++){
            ...
            if(!bb.codigoBanco.equals("033"))return;
...
//            PegaPagamento();
    ...
    private void PegaValores(){
        ...
        sql = "select count(*) from tb_boletos where idEmpresa = " + parametrosNS.be.IdEmpresa + " and substring(CodigoDeBarras, 1, 3) = '033';";
        dadosCount.clear();
        dadosCount = parametrosNS.dao.Consulta(sql);
        bbol.nossoNumero                = fc.FormataCampo(String.valueOf(Integer.parseInt(String.valueOf(dadosCount.get(0).get(0))) + 1), 13, 0);
        bbol.nossoNumero                = bbol.nossoNumero + CalDac.CalculaNossoNumeroSantander(bbol.nossoNumero);
        bbol.dataEmissao                = invdata.inverterData(txt_dataDeEmissao.getText(), 2);
        //Numero Do Documento está no Final desse método
        bbol.numeroDAC                  = "0"; //Santander Não necessita dess campo
        ...
        bbol.codigoDeBarras11           = "033";    //Numero Do Banco Na Camara de Compensação
        bbol.codigoDeBarras12           = "9";      //Código do R$
        bbol.codigoDeBarras13           = "9";      //Fixo "9"
        bbol.codigoDeBarras14           = "." + String.valueOf(bcc.numeroContaCorrente).substring(0, 4);
        ...
        bbol.codigoDeBarras21           = String.valueOf(bcc.numeroContaCorrente).substring(4, 6);
        bbol.codigoDeBarras22           = String.valueOf(bcc.digitoVerificador);
        bbol.codigoDeBarras23           = String.valueOf(bbol.nossoNumero.substring(0, 2)) + "." + bbol.nossoNumero.substring(2, 7);
        ...
        bbol.codigoDeBarras31           = bbol.nossoNumero.substring(7, 12) + "." + bbol.nossoNumero.substring(12, 13);
        bbol.codigoDeBarras32           = "0";
        bbol.codigoDeBarras33           = "102";
        ...
        bbol.CodigoDeBarras             = "033";
        bbol.CodigoDeBarras            += "9";
        bbol.CodigoDeBarras            += bbol.CodigoDeBarras5 + "9";
        bbol.CodigoDeBarras            += fc.FormataCampo(String.valueOf(bbol.codigoCliente), 7, 0);
        bbol.CodigoDeBarras            += "00000" + bbol.nossoNumero.substring(5, bbol.nossoNumero.length());
        bbol.CodigoDeBarras            += "0102";
...
//                new MostraMensagem(Mensagem);
    ...
    private void ImprimirBoleto(){
        try{
            ...
            jpv     = bpar.pastaRelatorios + "/BoletoSantander.jasper";
