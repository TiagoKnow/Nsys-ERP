...
import FuncoesInternas.EmailMontagem;
...
/*
 @author Tiago e Paulo 01/08/2016 19:00
 */
public class GerarBoletoItau extends javax.swing.JFrame {
    //String's
    String  sql                     = "";
    String  fatal                   = "";
    String  sqlstate                = "";
    ...
    BaixaManualDeBoletos    BaiManDeBol;
    ...
    public GerarBoletoItau(ArrayList DadosPadroes){
    ...
    private void PegaParametrosCC(){
        sql = "select * from tb_parametroscc where codigoGrupo = " + parametrosNS.bge.CodigoGrupo + " and codigoEmpresa = " + parametrosNS.be.CodigoEmpresa + ";";
    ...
    private void PegaImagemBoletos(){
        sql = "select imagemBoletos from tb_parametroscc where codigoGrupo = " + parametrosNS.bge.CodigoGrupo + " and codigoEmpresa = " + parametrosNS.be.CodigoEmpresa + ";";
    ...
    private void initComponents() {
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txt_parcelaAtual, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
                                    .addComponent(txt_qtdParcelas))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel4Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {check_VencimentoDiasUteis, combo_vencimentoDasParcelas, jLabel10, jLabel11, jLabel12, jLabel13, jLabel9, txt_dataDeEmissao, txt_dataDeVencimento, txt_parcelaAtual, txt_qtdParcelas});

        jPanel4Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel14, jLabel4, jLabel5, txt_valorDevido});

        jPanel4Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel15, txt_valorParcelas});
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(bt_gerar, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(bt_alterar, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(bt_baixaManual)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(bt_email, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(bt_imprimir, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(bt_baixaManual, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {bt_alterar, bt_baixaManual, bt_email, bt_gerar, bt_imprimir, bt_pesquisa, bt_sair});
    ...
    private void NovoBoleto(){
        ...
        bbol.codigoBoleto   = PegProReg.PegaProximoRegistro("tb_boletos", "codigoBoleto", " and substring(CodigoDeBarras, 1, 3) = 341");
    ...
    private void bt_alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_alterarActionPerformed
        ...
        sql = "update tb_boletos set numeroDAC = "              + bbol.numeroDAC                + ", "
                                  + "valorDevido = "            + bbol.valorDevido              + ", "
                                  ...
                                  + "CodigoDeBarras1 = '"       + bbol.CodigoDeBarras1          + "', "
                                  + "CodigoDeBarras2 = '"       + bbol.CodigoDeBarras2          + "', "
                                  + "CodigoDeBarras3 = '"       + bbol.CodigoDeBarras3          + "', "
                                  + "CodigoDeBarras4 = '"       + bbol.CodigoDeBarras4          + "', "
                                  + "CodigoDeBarras5 = '"       + bbol.CodigoDeBarras5          + "', "
                                  + "CodigoDeBarras = '"        + bbol.CodigoDeBarras           + "', "
                                  + "ocorrenciaRemessa = "      + bbol.ocorrenciaRemessa        + ", "
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        if(bbol.codigoBoleto == 0)
            if(bc.codigoCliente != 0){
                ...
                bbol.valorDevido = Double.parseDouble(String.valueOf(dadosPadroes.get(4)));
    ...
    private void bt_baixaManualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_baixaManualActionPerformed
        if(BaiManDeBol != null)if(BaiManDeBol.isVisible()){
            Mensagem = "Tela já Aberta!";
            new MostraMensagem(Mensagem);
            return;
        }
        parametros.clear();
        parametros.add(Integer.parseInt(txt_codigoBoleto.getText()));
        BaiManDeBol = new BaixaManualDeBoletos(parametros);
        BaiManDeBol.setVisible(true);
    ...
    private void PegaDadosBoleto(){
        for(int i = 0; i < dadosBoletos.size(); i++){
            ...
            if(!bb.codigoBanco.equals("341"))return;
...
//            PegaPagamento();
        ...
        if(bbol.ocorrenciaRetorno == 6)operacao = "";
        HabilitaBotoes();
        txt_codigoCliente           .setText(fc.FormataCampo(String.valueOf(bc.codigoCliente), 5, 0));
        txt_codigoCliente           .setEditable(false);
        bt_pesquisaCliente          .setEnabled (false);
    ...
    private void PegaValores(){
        ...
        sql = "select count(*) from tb_boletos where idEmpresa = " + parametrosNS.be.IdEmpresa + " and substring(CodigoDeBarras, 1, 3) = '341';";
        dadosCount.clear();
        dadosCount = parametrosNS.dao.Consulta(sql);
        bbol.nossoNumero                = fc.FormataCampo(String.valueOf(Integer.parseInt(String.valueOf(dadosCount.get(0).get(0))) + 1), 8, 0);
        bbol.dataEmissao                = invdata.inverterData(txt_dataDeEmissao.getText(), 2);
        //Numero Do Documento está no Final desse método
        bbol.numeroDAC                  = String.valueOf(CalDac.CalcularDAC(fc.FormataCampo(String.valueOf(bcc.numeroAgencia), 4, 0), fc.FormataCampo(String.valueOf(bcc.numeroContaCorrente), 5, 0), fc.FormataCampo(String.valueOf(bcc.numeroDaCarteira), 3, 0), bbol.nossoNumero));
        ...
        if(bbol.statusBoleto == 2)
            if(!invdata.inverterData(bbol.dataDeVencimento, 1).equals(txt_dataDeVencimento.getText()))
                if(JOptionPane.showConfirmDialog(null, "Confirmar alteração na data de vencimento?") != JOptionPane.YES_OPTION)
                    return;
                else
                    DataVencimento = "S";
        ...
        bbol.codigoDeBarras11           = "341";    //Numero Do Banco Na Camara de Compensação
        bbol.codigoDeBarras12           = "9";      //Código do R$
        bbol.codigoDeBarras13           = fc.FormataCampo(String.valueOf(bcc.numeroDaCarteira), 3, 0).substring(0, 1) + "." + fc.FormataCampo(String.valueOf(bcc.numeroDaCarteira), 3, 0).substring(1, 3);
        bbol.codigoDeBarras14           = bbol.nossoNumero.substring(0, 2);
        ...
        bbol.codigoDeBarras21           = bbol.nossoNumero.substring(2, 7) + "." + bbol.nossoNumero.substring(7, 8);
        bbol.codigoDeBarras22           = String.valueOf(bbol.numeroDAC);
        bbol.codigoDeBarras23           = String.valueOf(fc.FormataCampo(String.valueOf(bcc.numeroAgencia), 4, 0)).substring(0, 3);
        ...
        bbol.codigoDeBarras31           = String.valueOf(fc.FormataCampo(String.valueOf(bcc.numeroAgencia), 4, 0)).substring(3, 4);
        bbol.codigoDeBarras32           = fc.FormataCampo(String.valueOf(bcc.numeroContaCorrente), 5, 0).substring(0, 4) + "." + fc.FormataCampo(String.valueOf(bcc.numeroContaCorrente), 5, 0).substring(4, 5) + String.valueOf(bcc.digitoVerificador);
        bbol.codigoDeBarras33           = "000";
        ...
        bbol.CodigoDeBarras             = "341";
        bbol.CodigoDeBarras            += "9";
        bbol.CodigoDeBarras            += bbol.CodigoDeBarras5;
        bbol.CodigoDeBarras            += fc.FormataCampo(bcc.numeroDaCarteira, 3, 0) + bbol.nossoNumero + String.valueOf(bbol.numeroDAC);
        bbol.CodigoDeBarras            += fc.FormataCampo(String.valueOf(bcc.numeroAgencia), 4, 0) + fc.FormataCampo(String.valueOf(bcc.numeroContaCorrente), 5, 0) + String.valueOf(bcc.digitoVerificador);
        bbol.CodigoDeBarras            += "000";
        ...
        if(operacao.equals("A")){
            if(bbol.ocorrenciaRetorno != 1)
                bbol.ocorrenciaRemessa  = 31;
        }
        if(DataVencimento.equals("S"))
            bbol.ocorrenciaRemessa = 6;
